...
describe('GET em /chocolates/total, deve retornar o total de chocolates', () => {
  it('Retorna o total de 4 chocolates', async () => {
...
describe('Get em /chocolates/search retorna o correto', () => {
  it('Retorna 2 chocolates quando o parametro for "Mo"', async () => {
...
describe('PUT na rota /chocolates/:id', () => {
  it('Verifica quando é passado um id válido', async () => {
    const response = await chai.request(app).put('/chocolates/4').send(  {name: "Mounds",
    brandId: 3})
